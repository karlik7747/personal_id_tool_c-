...
namespace personal_id_tool
{
    static class MainClass
    {
        ...
        static List<string> GetCorrectCodes(string text)
        {
        ...
        public static void Menu()
        {
            ...
            switch (option)
            {
                case "1":
                    ...
                    List<string> correctCodes = GetCorrectCodes(text);
                ...
                case "2":
                    ...
                    if (int.TryParse(Console.ReadLine(), out numberOfIDs))
                        for (int i = 0; i < numberOfIDs; i++)
                            Console.WriteLine(GenerateValidID());
                    else
